  ...
  return (
    <div className="mb-20">
      <div className="text-center mb-20">
        <h1 className="font-serif text-[55px] font-semibold mb-7">Promo This Month</h1>
      ...
      <div className="flex flex-col gap-9 items-center">
        <div className="flex justify-center gap-12">
          <Image src={pinkCropTop} className="h-[300px] w-[300px]" />
          <Image src={monokromJacket} className="h-[300px] w-[300px]" />
          <Image src={denimKids} className="h-[300px] w-[300px]" />
          <Image src={bikerJacket} className="h-[300px] w-[300px]" />
          <Image src={flowerBlouse} className="h-[300px] w-[300px]" />
        </div>
        <Link href={"/Promo"} className="border border-solid border-black text-[24px] px-6 py-3 ">
          View All
        </Link>
      </div>
    </div>
